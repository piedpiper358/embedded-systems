                              ...
                              4 ; This file was generated Sat Jan 12 21:37:00 2019
                              5 ;--------------------------------------------------------
                              6 	.module led
   ...
   21B5                     406 _led:
                    ...
                    0000    413 	ar0 = 0x00
                    0001    414 	ar1 = 0x01
   21B5 C0 1A               415 	push	_bp
   21B7 85 81 1A            416 	mov	_bp,sp
                            417 ;	SRC/led.c:55: if( n > 7 ) return;
   21BA E5 82               418 	mov	a,dpl
   21BC FA                  419 	mov	r2,a
   21BD 24 F8               420 	add	a,#0xff - 0x07
   21BF 50 02               421 	jnc	00102$
   21C1 80 32               422 	sjmp	00106$
   21C3                     423 00102$:
                            424 ;	SRC/led.c:57: c = old_led;
   21C3 AB 08               425 	mov	r3,_old_led
                            426 ;	SRC/led.c:59: mask <<= n;
   21C5 8A F0               427 	mov	b,r2
   21C7 05 F0               428 	inc	b
   21C9 74 01               429 	mov	a,#0x01
   21CB 80 02               430 	sjmp	00113$
   21CD                     431 00111$:
   21CD 25 E0               432 	add	a,acc
   21CF                     433 00113$:
   21CF D5 F0 FB            434 	djnz	b,00111$
   21D2 FA                  435 	mov	r2,a
                            436 ;	SRC/led.c:61: if( on )
   21D3 A8 1A               437 	mov	r0,_bp
   21D5 18                  438 	dec	r0
   21D6 18                  439 	dec	r0
   21D7 18                  440 	dec	r0
   21D8 E6                  441 	mov	a,@r0
   21D9 60 05               442 	jz	00104$
                            443 ;	SRC/led.c:62: c |= mask;
   21DB EA                  444 	mov	a,r2
   21DC 42 03               445 	orl	ar3,a
   21DE 80 05               446 	sjmp	00105$
   21E0                     447 00104$:
                            448 ;	SRC/led.c:64: c &= ~mask;         
   21E0 EA                  449 	mov	a,r2
   21E1 F4                  450 	cpl	a
   21E2 FA                  451 	mov	r2,a
   21E3 52 03               452 	anl	ar3,a
   21E5                     453 00105$:
                            454 ;	SRC/led.c:66: write_max( SV, c );     
   21E5 C0 03               455 	push	ar3
   21E7 C0 03               456 	push	ar3
   21E9 90 00 07            457 	mov	dptr,#0x0007
   21EC 12 21 93            458 	lcall	_write_max
   21EF 15 81               459 	dec	sp
   21F1 D0 03               460 	pop	ar3
                            461 ;	SRC/led.c:68: old_led = c;
   21F3 8B 08               462 	mov	_old_led,r3
   21F5                     463 00106$:
   21F5 D0 1A               464 	pop	_bp
   21F7 22                  465 	ret
                            466 ;------------------------------------------------------------
                            ...
                            474 ;	-----------------------------------------
   21F8                     475 _leds:
   21F8 AA 82               476 	mov	r2,dpl
                            477 ;	SRC/led.c:90: write_max( SV, on );     
   21FA C0 02               478 	push	ar2
   21FC C0 02               479 	push	ar2
   21FE 90 00 07            480 	mov	dptr,#0x0007
   2201 12 21 93            481 	lcall	_write_max
   2204 15 81               482 	dec	sp
   2206 D0 02               483 	pop	ar2
                            484 ;	SRC/led.c:92: old_led = on;
   2208 8A 08               485 	mov	_old_led,r2
   220A 22                  486 	ret
                            487 	.area CSEG    (CODE)
                            488 	.area CONST   (CODE)
                            489 	.area XINIT   (CODE)
