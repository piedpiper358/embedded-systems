   ...
   2193                     401 _write_max:
                    ...
                    0000    408 	ar0 = 0x00
                    0001    409 	ar1 = 0x01
   2193 C0 1A               410 	push	_bp
   2195 85 81 1A            411 	mov	_bp,sp
                            412 ;	SRC/max.c:52: unsigned char oldDPP = DPP;
                            413 ;	SRC/max.c:54: DPP     = MAXBASE;
                            414 ;	SRC/max.c:55: *regnum = val;
   2198 AC 84               415 	mov	r4,_DPP
   219A 75 84 08            416 	mov	_DPP,#0x08
   219D A8 1A               417 	mov	r0,_bp
   219F 18                  418 	dec	r0
   21A0 18                  419 	dec	r0
   21A1 18                  420 	dec	r0
   21A2 E6                  421 	mov	a,@r0
   21A3 F0                  422 	movx	@dptr,a
                            423 ;	SRC/max.c:56: DPP     = oldDPP;
   21A4 8C 84               424 	mov	_DPP,r4
   21A6 D0 1A               425 	pop	_bp
   21A8 22                  426 	ret
                            427 ;------------------------------------------------------------
   ...
   21A9 AC 84               442 	mov	r4,_DPP
   21AB 75 84 08            443 	mov	_DPP,#0x08
   21AE E0                  444 	movx	a,@dptr
   21AF FA                  445 	mov	r2,a
                            446 ;	SRC/max.c:79: DPP = oldDPP;
   21B0 8C 84               447 	mov	_DPP,r4
                            448 ;	SRC/max.c:81: return val;
   21B2 8A 82               449 	mov	dpl,r2
   21B4 22                  450 	ret
                            451 	.area CSEG    (CODE)
                            452 	.area CONST   (CODE)
                            453 	.area XINIT   (CODE)
