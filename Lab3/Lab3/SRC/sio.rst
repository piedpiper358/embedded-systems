   ...
   21A1 85 82 8D            412 	mov	_TH1,dpl
                            413 ;	SRC/sio.c:51: TMOD = TMOD & ~(T1_GATE | T1_CT | T1_M0 /*0*/) | T1_M1; //Таймер 1 будет работать в режиме autoreload
   ...
   21AF F5 89               420 	mov	_TMOD,a
                            421 ;	SRC/sio.c:53: TCON     |=  0x40; //Запуск таймера 1
   21B1 43 88 40            422 	orl	_TCON,#0x40
                            423 ;	SRC/sio.c:55: SCON      =  0x50; //Настройки последовательного канала
   21B4 75 98 50            424 	mov	_SCON,#0x50
                            425 ;	SRC/sio.c:56: ES        =  0;    //Запрещение прерываний от приемопередатчика
   ...
   2225                     503 00103$:
                            504 ;	SRC/sio.c:80: TMOD = TMOD & ~(T1_GATE | T1_CT | T1_M0 /*0*/) | T1_M1; //Таймер 1 будет работать в режиме autoreload
   ...
   2232 D2 8E               513 	setb	_TR1
                            514 ;	SRC/sio.c:84: SCON      =  0x50; //Настройки последовательного канала
   2234 75 98 50            515 	mov	_SCON,#0x50
                            516 ;	SRC/sio.c:85: ES        =  0;    //Запрещение прерываний от приемопередатчика
