                              ...
                              4 ; This file was generated Thu Nov 29 14:32:34 2018
                              5 ;--------------------------------------------------------
                              6 	.module counter
   ...
   24FF 7A 2A               428 	mov	r2,#_INT0_ISR
   2501 7B 25               429 	mov	r3,#(_INT0_ISR >> 8)
   2503 7C 80               430 	mov	r4,#0x80
   2505 C0 02               431 	push	ar2
   2507 C0 03               432 	push	ar3
   2509 C0 04               433 	push	ar4
   250B 90 20 03            434 	mov	dptr,#0x2003
   250E 12 24 C7            435 	lcall	_SetVector
   2511 15 81               436 	dec	sp
   2513 15 81               437 	dec	sp
   2515 15 81               438 	dec	sp
                            439 ;	SRC/counter.c:25: IT0=0x1; //ќпредел€ем тип запроса прерывани€: по спаду, а не по уровню
   2517 D2 88               440 	setb	_IT0
                            441 ;	SRC/counter.c:27: write_max(ENA, 0b0100000);
   2519 74 20               442 	mov	a,#0x20
   251B C0 E0               443 	push	acc
   251D 90 00 04            444 	mov	dptr,#0x0004
   2520 12 22 02            445 	lcall	_write_max
   2523 15 81               446 	dec	sp
                            447 ;	SRC/counter.c:29: EX0=1; //–азрешение внешнего прерывани€ 0
   2525 D2 A8               448 	setb	_EX0
                            449 ;	SRC/counter.c:30: EA = 1; //–азрешение всех прерываний
   2527 D2 AF               450 	setb	_EA
   2529 22                  451 	ret
                            452 ;------------------------------------------------------------
   ...
   252A                     460 _INT0_ISR:
                    ...
                    0010    467 	ar0 = 0x10
                    0011    468 	ar1 = 0x11
   252A C0 20               469 	push	bits
   252C C0 E0               470 	push	acc
   252E C0 F0               471 	push	b
   2530 C0 82               472 	push	dpl
   2532 C0 83               473 	push	dph
   2534 C0 02               474 	push	(0+2)
   2536 C0 03               475 	push	(0+3)
   2538 C0 04               476 	push	(0+4)
   253A C0 05               477 	push	(0+5)
   253C C0 06               478 	push	(0+6)
   253E C0 07               479 	push	(0+7)
   2540 C0 00               480 	push	(0+0)
   2542 C0 01               481 	push	(0+1)
   2544 C0 D0               482 	push	psw
   2546 75 D0 10            483 	mov	psw,#0x10
                            484 ;	SRC/counter.c:39: leds( int_counter++ );
   2549 85 1D 82            485 	mov	dpl,_int_counter
   254C 05 1D               486 	inc	_int_counter
   254E 75 D0 00            487 	mov	psw,#0x00
   2551 12 21 EF            488 	lcall	_leds
   2554 75 D0 10            489 	mov	psw,#0x10
   2557 D0 D0               490 	pop	psw
   2559 D0 01               491 	pop	(0+1)
   255B D0 00               492 	pop	(0+0)
   255D D0 07               493 	pop	(0+7)
   255F D0 06               494 	pop	(0+6)
   2561 D0 05               495 	pop	(0+5)
   2563 D0 04               496 	pop	(0+4)
   2565 D0 03               497 	pop	(0+3)
   2567 D0 02               498 	pop	(0+2)
   2569 D0 83               499 	pop	dph
   256B D0 82               500 	pop	dpl
   256D D0 F0               501 	pop	b
   256F D0 E0               502 	pop	acc
   2571 D0 20               503 	pop	bits
   2573 32                  504 	reti
                            505 	.area CSEG    (CODE)
                            506 	.area CONST   (CODE)
                            507 	.area XINIT   (CODE)
