                              ...
                              4 ; This file was generated Thu Nov 29 14:32:30 2018
                              5 ;--------------------------------------------------------
                              6 	.module led
   ...
   2161 75 18 00            384 	mov	_old_led,#0x00
                            385 ;--------------------------------------------------------
                            386 ; Home
                            387 ;--------------------------------------------------------
                            388 	.area HOME    (CODE)
   ...
   21AC                     406 _led:
                    ...
                    0000    413 	ar0 = 0x00
                    0001    414 	ar1 = 0x01
   21AC C0 1E               415 	push	_bp
   21AE 85 81 1E            416 	mov	_bp,sp
                            417 ;	SRC/led.c:55: if( n > 7 ) return;
   21B1 E5 82               418 	mov	a,dpl
   21B3 FA                  419 	mov	r2,a
   21B4 24 F8               420 	add	a,#0xff - 0x07
   21B6 50 02               421 	jnc	00102$
   21B8 80 32               422 	sjmp	00106$
   21BA                     423 00102$:
                            424 ;	SRC/led.c:57: c = old_led;
   21BA AB 18               425 	mov	r3,_old_led
                            426 ;	SRC/led.c:59: mask <<= n;
   21BC 8A F0               427 	mov	b,r2
   21BE 05 F0               428 	inc	b
   21C0 74 01               429 	mov	a,#0x01
   21C2 80 02               430 	sjmp	00113$
   21C4                     431 00111$:
   21C4 25 E0               432 	add	a,acc
   21C6                     433 00113$:
   21C6 D5 F0 FB            434 	djnz	b,00111$
   21C9 FA                  435 	mov	r2,a
                            436 ;	SRC/led.c:61: if( on )
   21CA A8 1E               437 	mov	r0,_bp
   21CC 18                  438 	dec	r0
   21CD 18                  439 	dec	r0
   21CE 18                  440 	dec	r0
   21CF E6                  441 	mov	a,@r0
   21D0 60 05               442 	jz	00104$
                            443 ;	SRC/led.c:62: c |= mask;
   21D2 EA                  444 	mov	a,r2
   21D3 42 03               445 	orl	ar3,a
   21D5 80 05               446 	sjmp	00105$
   21D7                     447 00104$:
                            448 ;	SRC/led.c:64: c &= ~mask;         
   21D7 EA                  449 	mov	a,r2
   21D8 F4                  450 	cpl	a
   21D9 FA                  451 	mov	r2,a
   21DA 52 03               452 	anl	ar3,a
   21DC                     453 00105$:
                            454 ;	SRC/led.c:66: write_max( SV, c );     
   21DC C0 03               455 	push	ar3
   21DE C0 03               456 	push	ar3
   21E0 90 00 07            457 	mov	dptr,#0x0007
   21E3 12 22 02            458 	lcall	_write_max
   21E6 15 81               459 	dec	sp
   21E8 D0 03               460 	pop	ar3
                            461 ;	SRC/led.c:68: old_led = c;
   21EA 8B 18               462 	mov	_old_led,r3
   21EC                     463 00106$:
   21EC D0 1E               464 	pop	_bp
   21EE 22                  465 	ret
                            466 ;------------------------------------------------------------
                            ...
                            474 ;	-----------------------------------------
   21EF                     475 _leds:
   21EF AA 82               476 	mov	r2,dpl
                            477 ;	SRC/led.c:90: write_max( SV, on );     
   21F1 C0 02               478 	push	ar2
   21F3 C0 02               479 	push	ar2
   21F5 90 00 07            480 	mov	dptr,#0x0007
   21F8 12 22 02            481 	lcall	_write_max
   21FB 15 81               482 	dec	sp
   21FD D0 02               483 	pop	ar2
                            484 ;	SRC/led.c:92: old_led = on;
   21FF 8A 18               485 	mov	_old_led,r2
   2201 22                  486 	ret
                            487 	.area CSEG    (CODE)
                            488 	.area CONST   (CODE)
                            489 	.area XINIT   (CODE)
