   ...
   2202                     401 _write_max:
                    ...
                    0000    408 	ar0 = 0x00
                    0001    409 	ar1 = 0x01
   2202 C0 1E               410 	push	_bp
   2204 85 81 1E            411 	mov	_bp,sp
                            412 ;	SRC/max.c:52: unsigned char oldDPP = DPP;
                            413 ;	SRC/max.c:54: DPP     = MAXBASE;
                            414 ;	SRC/max.c:55: *regnum = val;
   2207 AC 84               415 	mov	r4,_DPP
   2209 75 84 08            416 	mov	_DPP,#0x08
   220C A8 1E               417 	mov	r0,_bp
   220E 18                  418 	dec	r0
   220F 18                  419 	dec	r0
   2210 18                  420 	dec	r0
   2211 E6                  421 	mov	a,@r0
   2212 F0                  422 	movx	@dptr,a
                            423 ;	SRC/max.c:56: DPP     = oldDPP;
   2213 8C 84               424 	mov	_DPP,r4
   2215 D0 1E               425 	pop	_bp
   2217 22                  426 	ret
                            427 ;------------------------------------------------------------
   ...
   2218 AC 84               442 	mov	r4,_DPP
   221A 75 84 08            443 	mov	_DPP,#0x08
   221D E0                  444 	movx	a,@dptr
   221E FA                  445 	mov	r2,a
                            446 ;	SRC/max.c:79: DPP = oldDPP;
   221F 8C 84               447 	mov	_DPP,r4
                            448 ;	SRC/max.c:81: return val;
   2221 8A 82               449 	mov	dpl,r2
   2223 22                  450 	ret
                            451 	.area CSEG    (CODE)
                            452 	.area CONST   (CODE)
                            453 	.area XINIT   (CODE)
