                              ...
                              4 ; This file was generated Thu Jan 24 01:04:30 2019
                              5 ;--------------------------------------------------------
                              6 	.module max
   ...
   0000                     326 	.ds 8
                            ...
                            389 	.area CSEG    (CODE)
                            390 ;------------------------------------------------------------
                            391 ;Allocation info for local variables in function 'WriteMax'
                            392 ;------------------------------------------------------------
                            393 ;val                       Allocated to stack - offset -3
                            394 ;regnum                    Allocated to registers r2 r3 
                            395 ;oldDPP                    Allocated to registers r4 
                            396 ;------------------------------------------------------------
                            397 ;	SRC/max.c:53: void WriteMax(unsigned char xdata *regnum, unsigned char val)
                            398 ;	-----------------------------------------
                            399 ;	 function WriteMax
                            400 ;	-----------------------------------------
   21AA                     401 _WriteMax:
                    0002    402 	ar2 = 0x02
                    0003    403 	ar3 = 0x03
                    ...
                    0000    408 	ar0 = 0x00
                    0001    409 	ar1 = 0x01
   21AA C0 1E               410 	push	_bp
   21AC 85 81 1E            411 	mov	_bp,sp
                            412 ;	SRC/max.c:55: unsigned char oldDPP=DPP;
                            413 ;	SRC/max.c:57: DPP=MAXBASE;
                            414 ;	SRC/max.c:58: *regnum=val;
   21AF AC 84               415 	mov	r4,_DPP
   21B1 75 84 08            416 	mov	_DPP,#0x08
   21B4 A8 1E               417 	mov	r0,_bp
   21B6 18                  418 	dec	r0
   21B7 18                  419 	dec	r0
   21B8 18                  420 	dec	r0
   21B9 E6                  421 	mov	a,@r0
   21BA F0                  422 	movx	@dptr,a
                            423 ;	SRC/max.c:59: DPP=oldDPP;
   21BB 8C 84               424 	mov	_DPP,r4
   21BD D0 1E               425 	pop	_bp
   21BF 22                  426 	ret
                            427 ;------------------------------------------------------------
                            428 ;Allocation info for local variables in function 'ReadMax'
                            429 ;------------------------------------------------------------
                            430 ;regnum                    Allocated to registers r2 r3 
                            431 ;oldDPP                    Allocated to registers r4 
                            432 ;val                       Allocated to registers r2 
                            433 ;------------------------------------------------------------
                            434 ;	SRC/max.c:75: unsigned char ReadMax(unsigned char xdata *regnum)
                            435 ;	-----------------------------------------
                            436 ;	 function ReadMax
                            437 ;	-----------------------------------------
   21C0                     438 _ReadMax:
                            439 ;	SRC/max.c:77: unsigned char oldDPP=DPP;
                            440 ;	SRC/max.c:80: DPP=MAXBASE;
                            441 ;	SRC/max.c:81: val=*regnum;
   21C0 AC 84               442 	mov	r4,_DPP
   21C2 75 84 08            443 	mov	_DPP,#0x08
   21C5 E0                  444 	movx	a,@dptr
   21C6 FA                  445 	mov	r2,a
                            446 ;	SRC/max.c:82: DPP=oldDPP;
   21C7 8C 84               447 	mov	_DPP,r4
                            448 ;	SRC/max.c:83: return val;
   21C9 8A 82               449 	mov	dpl,r2
   21CB 22                  450 	ret
                            451 	.area CSEG    (CODE)
                            452 	.area CONST   (CODE)
                            453 	.area XINIT   (CODE)
