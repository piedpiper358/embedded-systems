...
_SYS_TIMER_ISR:
	...
	push	psw
	mov	psw,#0x08
;	SRC/timer.c:55: TH = 0xFC; // Инициализация таймера:
	mov	_TH1,#0xFC
;	SRC/timer.c:56: TL = 0x66; // настройка на частоту работы 1000 Гц (чуть больше)
	mov	_TL1,#0x66
;	SRC/timer.c:57: __systime++; // Время в милисекундах
	inc	___systime
	clr	a
