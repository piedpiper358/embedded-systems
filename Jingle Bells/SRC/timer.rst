   ...
   239F C2 8E               422 	clr	_TR1
                            423 ;	SRC/timer.c:35: TMOD = TMOD & ~(GATE | CT | M1) | M0;
   23A1 AA 89               424 	mov	r2,_TMOD
   23A3 74 1F               425 	mov	a,#0x1F
   23A5 5A                  426 	anl	a,r2
   23A6 F5 F0               427 	mov	b,a
   23A8 74 10               428 	mov	a,#0x10
   23AA 45 F0               429 	orl	a,b
   23AC F5 89               430 	mov	_TMOD,a
                            431 ;	SRC/timer.c:38: TH = 0xFC;
   23AE 75 8D FC            432 	mov	_TH1,#0xFC
                            433 ;	SRC/timer.c:39: TL = 0x66; 
   23B1 75 8B 66            434 	mov	_TL1,#0x66
                            435 ;	SRC/timer.c:41: TR=0x1;
   23B4 D2 8E               436 	setb	_TR1
                            437 ;	SRC/timer.c:43: SetVector( vec, (void *)SYS_TIMER_ISR );
   23B6 7A D3               438 	mov	r2,#_SYS_TIMER_ISR
   23B8 7B 23               439 	mov	r3,#(_SYS_TIMER_ISR >> 8)
   23BA 7C 80               440 	mov	r4,#0x80
   23BC C0 02               441 	push	ar2
   23BE C0 03               442 	push	ar3
   23C0 C0 04               443 	push	ar4
   23C2 90 20 1B            444 	mov	dptr,#0x201B
   23C5 12 24 9D            445 	lcall	_SetVector
   23C8 15 81               446 	dec	sp
   23CA 15 81               447 	dec	sp
   23CC 15 81               448 	dec	sp
                            449 ;	SRC/timer.c:45: ET = 1; 
   23CE D2 AB               450 	setb	_ET1
                            451 ;	SRC/timer.c:47: EA = 1;
   23D0 D2 AF               452 	setb	_EA
   23D2 22                  453 	ret
                            454 ;------------------------------------------------------------
   ...
   23D3                     462 _SYS_TIMER_ISR:
                    ...
                    0008    469 	ar0 = 0x08
                    0009    470 	ar1 = 0x09
   23D3 C0 E0               471 	push	acc
   23D5 C0 D0               472 	push	psw
   23D7 75 D0 08            473 	mov	psw,#0x08
                            474 ;	SRC/timer.c:55: TH = 0xFC; // Инициализация таймера:
   23DA 75 8D FC            475 	mov	_TH1,#0xFC
                            476 ;	SRC/timer.c:56: TL = 0x66; // настройка на частоту работы 1000 Гц (чуть больше)
   23DD 75 8B 66            477 	mov	_TL1,#0x66
                            478 ;	SRC/timer.c:57: __systime++; // Время в милисекундах
   23E0 05 19               479 	inc	___systime
   23E2 E4                  480 	clr	a
   23E3 B5 19 0C            481 	cjne	a,___systime,00103$
   23E6 05 1A               482 	inc	(___systime + 1)
   23E8 B5 1A 07            483 	cjne	a,(___systime + 1),00103$
   23EB 05 1B               484 	inc	(___systime + 2)
   23ED B5 1B 02            485 	cjne	a,(___systime + 2),00103$
   23F0 05 1C               486 	inc	(___systime + 3)
   23F2                     487 00103$:
   23F2 D0 D0               488 	pop	psw
   23F4 D0 E0               489 	pop	acc
   23F6 32                  490 	reti
   ...
   23F7 C2 AB               513 	clr	_ET1
                            514 ;	SRC/timer.c:67: res = __systime;
   23F9 AA 19               515 	mov	r2,___systime
   23FB AB 1A               516 	mov	r3,(___systime + 1)
   23FD AC 1B               517 	mov	r4,(___systime + 2)
   23FF AD 1C               518 	mov	r5,(___systime + 3)
                            519 ;	SRC/timer.c:68: ET = 1;
   2401 D2 AB               520 	setb	_ET1
                            521 ;	SRC/timer.c:69: return res;
   2403 8A 82               522 	mov	dpl,r2
   2405 8B 83               523 	mov	dph,r3
   2407 8C F0               524 	mov	b,r4
   2409 ED                  525 	mov	a,r5
   240A 22                  526 	ret
                            527 ;------------------------------------------------------------
                            ...
                            536 ;	-----------------------------------------
   240B                     537 _DTimeMs:
   240B C0 1E               538 	push	_bp
   240D 85 81 1E            539 	mov	_bp,sp
   2410 C0 82               540 	push	dpl
   2412 C0 83               541 	push	dph
   2414 C0 F0               542 	push	b
   2416 C0 E0               543 	push	acc
                            544 ;	SRC/timer.c:81: unsigned long t1 = GetMsCounter();
   2418 12 23 F7            545 	lcall	_GetMsCounter
   241B AE 82               546 	mov	r6,dpl
   241D AF 83               547 	mov	r7,dph
   241F AA F0               548 	mov	r2,b
   2421 FB                  549 	mov	r3,a
                            550 ;	SRC/timer.c:82: return t1 - t0;
   2422 A8 1E               551 	mov	r0,_bp
   2424 08                  552 	inc	r0
   2425 EE                  553 	mov	a,r6
   2426 C3                  554 	clr	c
   2427 96                  555 	subb	a,@r0
   2428 FE                  556 	mov	r6,a
   2429 EF                  557 	mov	a,r7
   242A 08                  558 	inc	r0
   242B 96                  559 	subb	a,@r0
   242C FF                  560 	mov	r7,a
   242D EA                  561 	mov	a,r2
   242E 08                  562 	inc	r0
   242F 96                  563 	subb	a,@r0
   2430 FA                  564 	mov	r2,a
   2431 EB                  565 	mov	a,r3
   2432 08                  566 	inc	r0
   2433 96                  567 	subb	a,@r0
   2434 8E 82               568 	mov	dpl,r6
   2436 8F 83               569 	mov	dph,r7
   2438 8A F0               570 	mov	b,r2
   243A 85 1E 81            571 	mov	sp,_bp
   243D D0 1E               572 	pop	_bp
   243F 22                  573 	ret
                            574 ;------------------------------------------------------------
                            ...
                            583 ;	-----------------------------------------
   2440                     584 _DelayMs:
   2440 C0 1E               585 	push	_bp
   2442 85 81 1E            586 	mov	_bp,sp
   2445 C0 82               587 	push	dpl
   2447 C0 83               588 	push	dph
   2449 C0 F0               589 	push	b
   244B C0 E0               590 	push	acc
   244D E5 81               591 	mov	a,sp
   244F 24 08               592 	add	a,#0x08
   2451 F5 81               593 	mov	sp,a
                            594 ;	SRC/timer.c:89: unsigned long t1 = ( unsigned long )GetMsCounter();
   2453 12 23 F7            595 	lcall	_GetMsCounter
   2456 AA 82               596 	mov	r2,dpl
   2458 AB 83               597 	mov	r3,dph
   245A AC F0               598 	mov	r4,b
   245C FD                  599 	mov	r5,a
   245D E5 1E               600 	mov	a,_bp
   245F 24 05               601 	add	a,#0x05
   2461 F8                  602 	mov	r0,a
   2462 A6 02               603 	mov	@r0,ar2
   2464 08                  604 	inc	r0
   2465 A6 03               605 	mov	@r0,ar3
   2467 08                  606 	inc	r0
   2468 A6 04               607 	mov	@r0,ar4
   246A 08                  608 	inc	r0
   246B A6 05               609 	mov	@r0,ar5
                            610 ;	SRC/timer.c:90: while ( DTimeMs( t1 ) <= t );
   246D                     611 00101$:
   246D E5 1E               612 	mov	a,_bp
   246F 24 05               613 	add	a,#0x05
   2471 F8                  614 	mov	r0,a
   2472 86 82               615 	mov	dpl,@r0
   2474 08                  616 	inc	r0
   2475 86 83               617 	mov	dph,@r0
   2477 08                  618 	inc	r0
   2478 86 F0               619 	mov	b,@r0
   247A 08                  620 	inc	r0
   247B E6                  621 	mov	a,@r0
   247C 12 24 0B            622 	lcall	_DTimeMs
   247F AC 82               623 	mov	r4,dpl
   2481 AD 83               624 	mov	r5,dph
   2483 AA F0               625 	mov	r2,b
   2485 FB                  626 	mov	r3,a
   2486 A8 1E               627 	mov	r0,_bp
   2488 08                  628 	inc	r0
   2489 C3                  629 	clr	c
   248A E6                  630 	mov	a,@r0
   248B 9C                  631 	subb	a,r4
   248C 08                  632 	inc	r0
   248D E6                  633 	mov	a,@r0
   248E 9D                  634 	subb	a,r5
   248F 08                  635 	inc	r0
   2490 E6                  636 	mov	a,@r0
   2491 9A                  637 	subb	a,r2
   2492 08                  638 	inc	r0
   2493 E6                  639 	mov	a,@r0
   2494 9B                  640 	subb	a,r3
   2495 50 D6               641 	jnc	00101$
   2497 85 1E 81            642 	mov	sp,_bp
   249A D0 1E               643 	pop	_bp
   249C 22                  644 	ret
                            645 ;------------------------------------------------------------
                            ...
                            655 ;	-----------------------------------------
   249D                     656 _SetVector:
   249D C0 1E               657 	push	_bp
   249F 85 81 1E            658 	mov	_bp,sp
                            659 ;	SRC/timer.c:108: *Address = 0x02;
   24A2 AA 82               660 	mov	r2,dpl
   24A4 AB 83               661 	mov  r3,dph
   24A6 74 02               662 	mov	a,#0x02
   24A8 F0                  663 	movx	@dptr,a
                            664 ;	SRC/timer.c:110: TmpVector = (unsigned char xdata *) (Address + 1);
   24A9 0A                  665 	inc	r2
   24AA BA 00 01            666 	cjne	r2,#0x00,00103$
   24AD 0B                  667 	inc	r3
   24AE                     668 00103$:
                            669 ;	SRC/timer.c:111: *TmpVector = (unsigned char) ((unsigned short)Vector >> 8);
   24AE E5 1E               670 	mov	a,_bp
   24B0 24 FB               671 	add	a,#0xfb
   24B2 F8                  672 	mov	r0,a
   24B3 86 04               673 	mov	ar4,@r0
   24B5 08                  674 	inc	r0
   24B6 86 05               675 	mov	ar5,@r0
   24B8 8D 04               676 	mov	ar4,r5
   24BA 8A 82               677 	mov	dpl,r2
   24BC 8B 83               678 	mov	dph,r3
   24BE EC                  679 	mov	a,r4
   24BF F0                  680 	movx	@dptr,a
   24C0 A3                  681 	inc	dptr
   24C1 AA 82               682 	mov	r2,dpl
   24C3 AB 83               683 	mov	r3,dph
                            684 ;	SRC/timer.c:112: ++TmpVector;
                            685 ;	SRC/timer.c:113: *TmpVector = (unsigned char) Vector;
   24C5 E5 1E               686 	mov	a,_bp
   24C7 24 FB               687 	add	a,#0xfb
   24C9 F8                  688 	mov	r0,a
   24CA 86 04               689 	mov	ar4,@r0
   24CC 8A 82               690 	mov	dpl,r2
   24CE 8B 83               691 	mov	dph,r3
   24D0 EC                  692 	mov	a,r4
   24D1 F0                  693 	movx	@dptr,a
   24D2 D0 1E               694 	pop	_bp
   24D4 22                  695 	ret
                            696 	.area CSEG    (CODE)
                            697 	.area CONST   (CODE)
                            698 	.area XINIT   (CODE)
