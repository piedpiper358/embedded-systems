   ...
   2182                     406 _led:
                    ...
                    0000    413 	ar0 = 0x00
                    0001    414 	ar1 = 0x01
   2182 C0 1E               415 	push	_bp
   2184 85 81 1E            416 	mov	_bp,sp
                            417 ;	SRC/led.c:55: if( n > 7 ) return;
   2187 E5 82               418 	mov	a,dpl
   2189 FA                  419 	mov	r2,a
   218A 24 F8               420 	add	a,#0xff - 0x07
   218C 50 02               421 	jnc	00102$
   218E 80 32               422 	sjmp	00106$
   2190                     423 00102$:
                            424 ;	SRC/led.c:57: c = old_led;
   2190 AB 18               425 	mov	r3,_old_led
                            426 ;	SRC/led.c:59: mask <<= n;
   2192 8A F0               427 	mov	b,r2
   2194 05 F0               428 	inc	b
   2196 74 01               429 	mov	a,#0x01
   2198 80 02               430 	sjmp	00113$
   219A                     431 00111$:
   219A 25 E0               432 	add	a,acc
   219C                     433 00113$:
   219C D5 F0 FB            434 	djnz	b,00111$
   219F FA                  435 	mov	r2,a
                            436 ;	SRC/led.c:61: if( on )
   21A0 A8 1E               437 	mov	r0,_bp
   21A2 18                  438 	dec	r0
   21A3 18                  439 	dec	r0
   21A4 18                  440 	dec	r0
   21A5 E6                  441 	mov	a,@r0
   21A6 60 05               442 	jz	00104$
                            443 ;	SRC/led.c:62: c |= mask;
   21A8 EA                  444 	mov	a,r2
   21A9 42 03               445 	orl	ar3,a
   21AB 80 05               446 	sjmp	00105$
   21AD                     447 00104$:
                            448 ;	SRC/led.c:64: c &= ~mask;         
   21AD EA                  449 	mov	a,r2
   21AE F4                  450 	cpl	a
   21AF FA                  451 	mov	r2,a
   21B0 52 03               452 	anl	ar3,a
   21B2                     453 00105$:
                            454 ;	SRC/led.c:66: write_max( SV, c );     
   21B2 C0 03               455 	push	ar3
   21B4 C0 03               456 	push	ar3
   21B6 90 00 07            457 	mov	dptr,#0x0007
   21B9 12 21 D8            458 	lcall	_write_max
   21BC 15 81               459 	dec	sp
   21BE D0 03               460 	pop	ar3
                            461 ;	SRC/led.c:68: old_led = c;
   21C0 8B 18               462 	mov	_old_led,r3
   21C2                     463 00106$:
   21C2 D0 1E               464 	pop	_bp
   21C4 22                  465 	ret
                            466 ;------------------------------------------------------------
                            ...
                            474 ;	-----------------------------------------
   21C5                     475 _leds:
   21C5 AA 82               476 	mov	r2,dpl
                            477 ;	SRC/led.c:90: write_max( SV, on );     
   21C7 C0 02               478 	push	ar2
   21C9 C0 02               479 	push	ar2
   21CB 90 00 07            480 	mov	dptr,#0x0007
   21CE 12 21 D8            481 	lcall	_write_max
   21D1 15 81               482 	dec	sp
   21D3 D0 02               483 	pop	ar2
                            484 ;	SRC/led.c:92: old_led = on;
   21D5 8A 18               485 	mov	_old_led,r2
   21D7 22                  486 	ret
                            487 	.area CSEG    (CODE)
                            488 	.area CONST   (CODE)
                            489 	.area XINIT   (CODE)
