   ...
   21D8                     401 _write_max:
                    ...
                    0000    408 	ar0 = 0x00
                    0001    409 	ar1 = 0x01
   21D8 C0 1E               410 	push	_bp
   21DA 85 81 1E            411 	mov	_bp,sp
                            412 ;	SRC/max.c:52: unsigned char oldDPP = DPP;
                            413 ;	SRC/max.c:54: DPP     = MAXBASE;
                            414 ;	SRC/max.c:55: *regnum = val;
   21DD AC 84               415 	mov	r4,_DPP
   21DF 75 84 08            416 	mov	_DPP,#0x08
   21E2 A8 1E               417 	mov	r0,_bp
   21E4 18                  418 	dec	r0
   21E5 18                  419 	dec	r0
   21E6 18                  420 	dec	r0
   21E7 E6                  421 	mov	a,@r0
   21E8 F0                  422 	movx	@dptr,a
                            423 ;	SRC/max.c:56: DPP     = oldDPP;
   21E9 8C 84               424 	mov	_DPP,r4
   21EB D0 1E               425 	pop	_bp
   21ED 22                  426 	ret
                            427 ;------------------------------------------------------------
   ...
   21EE AC 84               442 	mov	r4,_DPP
   21F0 75 84 08            443 	mov	_DPP,#0x08
   21F3 E0                  444 	movx	a,@dptr
   21F4 FA                  445 	mov	r2,a
                            446 ;	SRC/max.c:79: DPP = oldDPP;
   21F5 8C 84               447 	mov	_DPP,r4
                            448 ;	SRC/max.c:81: return val;
   21F7 8A 82               449 	mov	dpl,r2
   21F9 22                  450 	ret
                            451 	.area CSEG    (CODE)
                            452 	.area CONST   (CODE)
                            453 	.area XINIT   (CODE)
